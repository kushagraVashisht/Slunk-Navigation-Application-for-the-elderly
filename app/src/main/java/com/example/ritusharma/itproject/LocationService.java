...
public class LocationService extends Service {
    ...
    private void buildNotification() {
        ...
        PendingIntent broadcastIntent = PendingIntent.getBroadcast(this, 0, new Intent(stop),
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                ...
                .setOngoing(true).setContentIntent(broadcastIntent).setSmallIcon(R.drawable.ic_traker);
