...
public class SinchService extends Service {
    ...
    private static final String APP_KEY = "b88dd77d-b726-4521-a794-522b0654711c";
    private static final String APP_SECRET = "1f0keqZIdUel1+tt3Os9Sg==";
...
//            mSinchClient.terminate();
    ...
    private class SinchCallClientListener implements CallClientListener {
        ...
        public void onIncomingCall(CallClient callClient, Call call) {
            ...
            intent.putExtra(CALLER_NAME,call.getHeaders().get("CallerName"));
            intent.putExtra(CALL_TYPE,call.getHeaders().get("CallType"));
